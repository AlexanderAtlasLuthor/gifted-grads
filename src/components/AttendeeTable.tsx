      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-white/6 text-xs uppercase tracking-[0.16em] text-[#8FA9C4]">
              <tr>
            ...
            <tbody className="divide-y divide-white/[0.08]">
              {data?.items.map((a) => (
                <tr
                  key={a.id}
                  className="cursor-pointer transition hover:bg-white/[0.08]"
                  onClick={() => setSelected(a)}
                >
                  <td className="px-4 py-2 font-mono text-accent-200">
